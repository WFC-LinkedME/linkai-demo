...
public class NativeExpressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aiNativeExpressAd = new AiNativeExpressAd(this, "123", aiExpressAdConfigBuilder.build());
...
//                Toast.makeText(mContext, "图片展示样式错误", Toast.LENGTH_SHORT).show();
        ...
        //渲染视频广告，以视频广告为例，以下说明
        @SuppressWarnings("RedundantCast")
        private View getVideoView(View convertView, ViewGroup parent, @NonNull final AiNativeExpress ad) {
